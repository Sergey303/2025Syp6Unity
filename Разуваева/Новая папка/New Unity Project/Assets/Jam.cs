        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (target != null)
            {
                ...
                if (target.name == "left")
                {
                    ...
                    images[kartina_id].sprite = Img_class[kartina_id]?.cats[cats_nambers[kartina_id]];
                }
                if (target.name == "right")
                {
                    cats_nambers[kartina_id] += 1;
                    if (cats_nambers[kartina_id] > 2)
                    {
